...
export let state = {
    ...
    currentClientId: 1,
    clients: [
        { id: 1, name: 'Jan Kowalski', contact: 'jan.kowalski@example.com', subscription: { type: '12 wejść', entriesLeft: 8, expires: '2025-08-25' }, history: [{ date: '2025-08-13', duration: '180 sec', status: 'Odwiedzono', temperature: '-135°C' }, { date: '2025-07-30', duration: '180 sec', status: 'Odwiedzono', temperature: '-135°C' }, { date: '2025-07-28', duration: '150 sec', status: 'Odwiedzono', temperature: '-130°C' }, { date: '2025-07-25', status: 'Opuszczono', temperature: null, duration: null }], notes: 'Ma lekką kontuzję kolana, unikać dużych obciążeń.' },
